...
from watermark_layers import WatermarkEmbedding, WatermarkAddition
...
def main():
    ...
    msg_bits = np.random.randint(0, 2,
                                 size=(batch_size, num_frames, bits_per_frame),
                                 dtype=np.int32)
    ...
    print("Watermark component stats:  min={:.5f}, max={:.5f}, mean={:.5f}".format(
    ...
    print("Marked residual stats:    min={:.5f}, max={:.5f}, mean={:.5f}".format(
